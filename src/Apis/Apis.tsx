...
export const fetchData = {
  addOrder: async (newOrder: CreateOrder) => {
    const result = await axios.post(
      `https://codemastersapi-production.up.railway.app/CreateOrder`,
      newOrder
    );
    return result;
  },
  getAllOrders: async (token: string | null) => {
    const result = await axios.get(
      `https://codemastersapi-production.up.railway.app/GetAllOrders`,
      {
  ...
  login: async (userLogins: UserLoginDto) => {
    const result = await axios.post(
      `https://codemastersapi-production.up.railway.app/Login`,
      userLogins,
      {
        withCredentials: true,
        headers: {},
